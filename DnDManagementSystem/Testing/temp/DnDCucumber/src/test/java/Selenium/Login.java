...
public class Login {
	...
	public void createAccountPlayer() {
		...
		WebElement usernameBox = driver.findElement(By.id("usernameinput2"));
		WebElement passwordBox = driver.findElement(By.id("passwordinput2"));
		WebElement loginButton = driver.findElement(By.id("submitButton2"));
		WebElement accountselector = driver.findElement(By.id("accounttype"));
		...
		passwordBox.sendKeys("pass3");
		accountselector.sendKeys("player");
